...
import org.springbootproject1.runnerz.run.JdbcRunRepository;
import org.springbootproject1.runnerz.run.Location;
import org.springbootproject1.runnerz.run.Run;
import org.springbootproject1.runnerz.run.RunController;
...
class RunControllerTest {
    ...
    void shouldCreateNewRun() throws Exception {
        Run run = new Run(null,"test", LocalDateTime.now(),LocalDateTime.now(),1, Location.INDOOR, null);
